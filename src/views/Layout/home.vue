<template>
  <div class="home">
    ...
    <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
      <van-swipe-item v-for="item in swiperList" :key="item.imgUrl">
...
<script>
import { GetHomePageDetailAPI } from '@/api/home';
...
export default {
  ...
  methods: {
    async GetHomePageDetailData() {
      const res = await GetHomePageDetailAPI()
